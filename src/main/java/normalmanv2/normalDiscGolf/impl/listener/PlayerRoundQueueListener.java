...
public class PlayerRoundQueueListener implements Listener {
    ...
    private final QueueManager queueManager = NDGManager.getInstance().getQueueManager();
    private final NormalDiscGolf plugin;

    public PlayerRoundQueueListener(NormalDiscGolf plugin) {
        this.plugin = plugin;
    }
                ...
                Bukkit.getScheduler().runTaskLater(plugin, () -> {
                    ...
                    newQueue[0] = this.queueManager.createQueue(
                            ...
                            new CourseImpl(difficulty, "New Course FFA", 18,
                                    courseGrid, world.getSpawnLocation(), ), false, "ffa", 4));
